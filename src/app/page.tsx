...
/** Inline icons so we don’t rely on any image files */
...
export default function Home() {
  const features = [
    ...
    {
      title: "Impact",
      desc: "Every order funds prevention.",
      Icon: IconHeart,
    },
  ];
  ...
  return (
    <div className="space-y-16">
      {/* HERO */}
      <section
        className="rounded-2xl border border-white/10 bg-[radial-gradient(1200px_600px_at_20%_-10%,rgba(56,189,248,.15),transparent),radial-gradient(800px_400px_at_100%_20%,rgba(16,185,129,.12),transparent)] p-6 md:p-10"
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mt-3 text-zinc-400">
              Focus, recovery, hydration, rest. Every purchase supports veteran suicide
              prevention.
            </p>
          ...
          {/* Decorative “hero art” made with CSS only (no external files) */}
          <div className="relative h-56 w-full overflow-hidden rounded-xl border border-white/10 md:h-72">
            <div className="absolute inset-0 bg-[conic-gradient(from_180deg_at_50%_50%,rgba(255,255,255,.06)_0deg,transparent_120deg,transparent_240deg,rgba(255,255,255,.06)_360deg)]" />
            <div className="absolute inset-0 bg-[radial-gradient(200px_100px_at_70%_30%,rgba(59,130,246,.22),transparent)]" />
            <div className="absolute inset-0 bg-[radial-gradient(240px_120px_at_30%_70%,rgba(16,185,129,.22),transparent)]" />
          </div>
        </div>
      </section>
