...
export const metadata: Metadata = {
  ...
  description: "Support for home base. Hydration, vitamins, recovery, rest.",
};
...
export default function HomefrontPage() {
  const kit = getKit("homefront");
  const title = asString(getPath(kit, ["title"]), "Homefront Kit");
    ...
    <main id="content" className="container py-10 space-y-8 max-w-5xl">
      <header className="grid gap-6 md:grid-cols-[1.2fr_.8fr] items-start">
        <div className="space-y-4">
          <h1>{title}</h1>
          <p className="muted">Support for home base. Hydration, vitamins, recovery, rest.</p>
