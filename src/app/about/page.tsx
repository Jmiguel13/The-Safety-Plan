    ...
    <div className="space-y-8">
      ...
      <section className="space-y-3">
        ...
        <ol className="cv grid gap-2">
          <li className="card"><div className="text-sm">Q3 2025 — Storefront beta goes live with Resilient & Homefront kits.</div></li>
          <li className="card"><div className="text-sm">Q4 2025 — Community pilots and expanded gallery of real-world use.</div></li>
          <li className="card"><div className="text-sm">2026 — Broader kit lineup and deeper partnerships.</div></li>
        </ol>
      </section>
    </div>
  );
